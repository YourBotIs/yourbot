defmodule YourBot.Accounts do
  ...
  def discord_oauth_registration(attrs \\ %{}) do
    Ecto.Multi.new()
    |> Ecto.Multi.insert(:discord_oauth, change_discord_oauth(%DiscordOauth{}, attrs))
    |> Ecto.Multi.run(:user, fn repo, %{discord_oauth: discord_oauth} ->
      %User{discord_oauth_id: discord_oauth.id}
